...
Macro ConstructSphereSurface
    ...
    sphereVolume = newreg; Volume(sphereVolume) = {surfaceLoop};
Return
// ###############################
// create sphere
// ###############################
...
hullVolume = newreg; Volume(hullVolume) = {boxSurface, surfaceLoop};
Physical Volume(1) = {sphereVolume};
Physical Volume(2) = {hullVolume};
Physical Surface(1) = {surfaceList[]};
